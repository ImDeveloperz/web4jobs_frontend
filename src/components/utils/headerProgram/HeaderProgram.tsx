            ...
            <div className='flex flex-col gap-6 lg:w-[58%] w-full md:pt-4 '>
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex gap-2 items-center'>
                        <p className='text-base font-normal'>{review}</p>
                ...
                <div className='flex flex-col gap-2'>
                    <h3 className='md:text-2xl text-[22px] font-bold'>{subTitle}</h3>
                    <p className='text-base font-normal'>{description}</p>
                </div>
            </div>
            <div className='lg:w-[45%]  hidden items-start justify-end lg:flex'>
                {imageUrl && <Image className='h-auto' src={imageUrl} alt={title} width={460} height={460} />}
            </div>
        </div>
    )
}
