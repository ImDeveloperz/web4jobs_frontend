  ...
  return (
    <div className={` text-primary-color pb-6 flex flex-col  gap-10 `}>
      <div className='flex flex-col gap-1'>
        ...
        <h3 className='font-normal text-xs md:text-base '>{subTitle} <a href={link} target="_blank" 
        rel="noopener noreferrer" className='text-secondary-color hover:underline cursor-pointer '>{subTitle2}</a></h3>
      </div>
